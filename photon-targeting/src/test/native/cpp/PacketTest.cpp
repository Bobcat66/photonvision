...
TEST(PacketTest, PhotonPipelineResult) {
  PhotonPipelineResult result(PhotonPipelineMetadata(0, 0, 1, 2),
                              std::vector<PhotonTrackedTarget>{}, std::nullopt, std::make_optional<frc::Transform3d>(frc::Transform3d{frc::Translation3d(0_m, 0_m, 1_m), frc::Rotation3d()}));
  ...
  PhotonPipelineResult result2(PhotonPipelineMetadata{0, 0, 1, 1}, targets,
                               mtResult, std::make_optional<frc::Transform3d>(frc::Transform3d{frc::Translation3d(0_m, 0_m, 1_m), frc::Rotation3d()}));
